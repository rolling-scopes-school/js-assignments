...
function getRectangleString(width, height) {
    return String.fromCharCode(250C) + String.fromCharCode(2500).repeat(width-2) + String.fromCharCode(2510) + '\n' + (String.fromCharCode(2502) + ' '.repeat(width-2) + String.fromCharCode(2502) + '\n').repeat(height-2) + String.fromCharCode(2514) + String.fromCharCode(2500).repeat(width-2) + String.fromCharCode(2518) + '\n';
}
...
function encodeToRot13(str) {
    let Ror13Str = '';
    return str.replace(/[A-Za-z]/g, function(char){ return String.fromCharCode(
        (char.charCodeAt(0) - (char <= 'Z'? 65: 97) + 13) % 26 + (char <= 'Z'? 65: 97));} );
}
