...
function getRectangleString(width, height) {
    ...
    width -= 2;
    height -= 2;
    str1 = str1.substring(0, 1) + "─".repeat(width) + str1.substring(1);
    str2 = str2.substring(0, 1) + " ".repeat(width) + str2.substring(1);
    str2 = str2.repeat(height);
    str3 = str3.substring(0, 1) + "─".repeat(width) + str3.substring(1);
