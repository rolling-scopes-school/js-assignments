...
* Run `git clone https://github.com/mirrox52/js-assignments.git` from command line to download the repo.
...
* Edit local README.md file and update all links (just replace all occurrences of `'mirrox52'` with your account name).
...
```
* Open https://github.com/mirrox52/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
