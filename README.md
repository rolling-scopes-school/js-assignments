...
## Javascript Assignments  [![Build Status](https://travis-ci.org/avg20/rolling-scopes-js-assignments.svg?branch=master)](https://travis-ci.org/avg20/rolling-scopes-js-assignments)
