...
## Javascript Assignments  [![Build Status](https://travis-ci.org/ElbekDeveloper/js-assignments.svg?branch=master)](https://travis-ci.org/ElbekDeveloper/js-assignments)
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/ElbekDeveloper/js-assignments/builds).
